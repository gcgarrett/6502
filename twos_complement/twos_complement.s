...
redraw:
    ...
    ; Initialize value with the number from the numbers table
    lda numbers,x ; Load low byte of number to display
    sta value     ; Store low byte of number to display in value
    inx           ; Increment x for high byte of number
    lda numbers,x ; Load high byte of number to display
...
end_inner_delay:
    ...
    ; Table of numbers to convert with twos complement to display
numbers:
    .word 32768    ; -32768
    .word 32769    ; -32767
    .word 32770    ; -32766
...
irq:
    ...
    and #%00011111 ; Wrap around after 31 (e.g. 32 becomes 0)
